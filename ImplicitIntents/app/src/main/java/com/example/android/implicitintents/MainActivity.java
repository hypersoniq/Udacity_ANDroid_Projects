...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * This is my own implicit intent that should open the calculator on a device
     * Cannot make it work on the emulator or my Samsung Galaxy Note 8
     * But at least the Toast message works... thanks for not using an example
    ...
    public void openCalculator(View v) {
        ...
        // Make sure device has an app that can handle the request
        if (intent.resolveActivity(getPackageManager()) != null) {
            startActivity(intent);
        } else {
            Toast.makeText(this, "Calculator app will not open", Toast.LENGTH_LONG).show();
        }
    }
